...
from .query_parser import parse_query, build_where_clause, load_known_entities
...
def agentic_retriever(question: str, collection, n_results: int = 10, max_retries: int = 3) -> str:
    """
...
if __name__ == "__main__":
    ...
    from embedder import COLLECTION_NAME, MODEL_NAME
